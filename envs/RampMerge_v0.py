...
import lass.bin.Lass as Lass
from utils.utils import Utils
from algos.idm import IDM
from algos.lks_pid import LKS_PID
from vehicles.category import CarIDM, CarNaive
...
class RampMerge_v0(gym.Env):
    ...
    def step(self, action):
        ...
        return [self.__abstract_state(self.__ego.state), self.__abstract_state(self.__bumper.state)], reward, ended, {
            't': t}
